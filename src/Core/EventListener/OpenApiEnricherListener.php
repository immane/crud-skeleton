...
class OpenApiEnricherListener
{
    ...
    private const META = [
        ...
        '/api/v1/manage/store-orders' => ['summary' => ['get' => 'List store orders'], 'desc' => ['get' => "Admin view. Supports @filter.\nExample: GET /api/v1/manage/store-orders?@filter=entity.getStore().getCode()==\"demo\"  Header: Authorization: Bearer <admin_jwt>"]],
        ...
        return match ($key) {
            ...
            'post:/api/v1/manage/contents' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['title'], 'properties' => [
                        'title' => ['type' => 'string', 'example' => 'Demo News: New Store Opening', 'description' => 'Content title, required'],
                        'body' => ['type' => 'string', 'example' => 'We are opening a new store in Demo...', 'nullable' => true, 'description' => 'Body text/markdown, nullable'],
                    ...
                    'example' => ['title' => 'Demo News: New Store Opening', 'body' => 'We are opening a new store in Demo...', 'category' => 1, 'tags' => [1,2], 'metadata' => ['source' => 'editorial', 'featured' => true]],
                ]],
            ],
            ...
            'post:/api/v1/manage/pages' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['title','slug'], 'properties' => [
                        ...
                        'body' => ['type' => 'string', 'example' => '# About Demo', 'nullable' => true, 'description' => 'Body markdown/html, nullable'],
                        'metaTitle' => ['type' => 'string', 'example' => 'About Demo - Community', 'nullable' => true, 'description' => 'SEO meta title'],
                        'metaDescription' => ['type' => 'string', 'example' => 'Learn about Demo', 'nullable' => true, 'description' => 'SEO meta description'],
                    ...
                    'example' => ['title' => 'About Us', 'slug' => 'about-us', 'body' => '# About Demo', 'metaTitle' => 'About Demo', 'metaDescription' => 'Learn about Demo', 'status' => 'published', 'publishedAt' => '2026-09-04T08:00:00+00:00'],
                ]],
            ],
            ...
            'post:/api/v1/manage/categories' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['name','slug'], 'properties' => [
                        ...
                        'description' => ['type' => 'string', 'example' => 'Demo news', 'nullable' => true, 'description' => 'Description nullable'],
                    ...
                    'example' => ['name' => 'News', 'slug' => 'news', 'description' => 'Demo news', 'parent' => null, 'sortOrder' => 1, 'enabled' => true],
                ]],
            ],
            ...
            'post:/api/v1/manage/media' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['filename','originalFilename','mimeType','size','path'], 'properties' => [
                        ...
                        'alt' => ['type' => 'string', 'nullable' => true, 'example' => 'Demo photo'],
            ...
            'post:/api/v1/manage/settings' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['key'], 'properties' => [
                        ...
                        'value' => ['type' => 'string', 'example' => 'Demo Online', 'nullable' => true],
                    ...
                    'example' => ['key' => 'site.name', 'value' => 'Demo Online', 'type' => 'string', 'groupName' => 'site'],
                ]],
            ],
            'put:/api/v1/manage/settings/{id}' => [
                ...
                'content' => ['application/json' => [
                    ...
                    'example' => ['value' => 'Demo V2', 'label' => 'Updated'],
                ]],
            ],
            'post:/api/v1/manage/settings/batch-update' => [
                ...
                'content' => ['application/json' => [
                    ...
                    'example' => [['key' => 'site.name', 'value' => 'Demo V2']],
                ]],
            ],
            ...
            'post:/api/v1/app/pictures' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['category','image'], 'properties' => [
                        ...
                        'metadata' => ['type' => 'object', 'nullable' => true, 'example' => ['location' => 'Demo']],
                    ]],
            ...
            'post:/api/v1/manage/promotions' => [
                ...
                'content' => ['application/json' => [
                    'schema' => ['type' => 'object', 'required' => ['name','template'], 'properties' => [
                        ...
                        'storeCode' => ['type' => 'string', 'example' => 'DEMO_STORE', 'nullable' => true],
                        'enabled' => ['type' => 'boolean', 'example' => true],
